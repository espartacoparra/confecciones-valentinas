...
<div class="panel panel-default animated fadeInRightBig" ng-app="realtime" ng-controller="charger" 
  ng-init="rutarealtime='{{$rutarealtime}}'; rutashowproduct='{{$rutashowproduct}}';rutadelorder='{{$rutadelorder}}';rutashowchat='{{ $rutashowchat }}'">
  <div class="panel-heading "><h4>Listados de Pedidos sin Recibos de Pago </h4></div>
    ...
    <div class="table-responsive">
  	<table  class="table table-hover" datatable="ng" dt-options="dtOptions" dt-column-defs="showCase.dtColumnDefs" >
        ...
        <td ><%l.price%></td>
          ...
          <a onclick="return confirm('Usted Esta seguro que desea eliminar el pedido #')" href=""><button class="btn btn-danger"  ng-click="delorder(l.id)">Eliminar</button></a> </td>
  		</tr>
      </tbody>
  	</table>
  </div>
