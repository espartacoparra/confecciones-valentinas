...
<link rel="stylesheet" type="text/css" href="{{asset('css/animate.css')}}">
    ...
    <!-- formulario css -->
<link rel="stylesheet" href="{{asset('templatestore/form.css')}}">
    <!-- Theme Style -->
  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-light">
        <div class="container">
          <a class="navbar-brand" href="{{ action("PrincipalController@index") }}" style="color: black"><img width="250px" src="{{ asset('templatestore/ConfeccionesValentinasrosa.png') }}"></a>
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 "  >
              ...
              <br>
              <br>
              <div id="marco" class="animated fadeInDown">
...
<div >
  ...
  {!!Form::text('name',null,['id'=>'color','placeholder'=>'Nombre', 'required'])!!}
</div>
<div>
...
<div >
  ...
  {!!Form::text('lastname',null,['id'=>'color','placeholder'=>'Apellido', 'required'])!!}
</div>
<div>

{!! $errors->first("lastname","<span class='help-block' style='color:red;'>:message</span>") !!}
</div >
<div >
  {!! Form::label('cedula','Cedula')!!}
  {!!Form::text('cedula',null,['id'=>'color','placeholder'=>'Cedula', 'required'])!!}
</div>
<div>

{!! $errors->first("cedula","<span class='help-block' style='color:red;'>:message</span>") !!}
</div >
<div >
  {!! Form::label('username','Usuario')!!}
  {!!Form::text('username',null,['id'=>'color','placeholder'=>'Usuario', 'required'])!!}
</div>
<div>
...
<div >
  ...
  {!!Form::text('phone',null,['id'=>'color','placeholder'=>'Telefono', 'required'])!!}
</div>
<div>
...
<div >
  ...
  {!!Form::email('email',null,['id'=>'color','placeholder'=>'Correo', 'required'])!!}
</div>
<div>
...
<div >
  ...
  {!!Form::password('password',null,['placeholder'=>'Contraseña', 'required'])!!}
</div>
<div>
