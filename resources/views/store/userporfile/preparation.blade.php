...
<!-- /.col-lg-3 -->
  ...
  <h5 class="card-header"  id="letrasrosa">PEDIDOS EN ESPERA DE VERIFICACN</h5>
  <div class="card-body" >
   <div class="table-responsive">
    <table  class="table table-hover" datatable="ng" dt-options="dtOptions" dt-column-defs="showCase.dtColumnDefs" ">
      ...
      <tr >
        ...
        <td >
        <a id="letrasrosa" href="{{ action('UserPorfileController@payorder',$s->id) }}"><button class="btn" id="letrasrosafondonegro">Datos del pedido</button></a>
...
<div class="card text-center animated fadeInUp">
  ...
  <div class="card-body" id="roa" >
    ...
    <p class="card-text" ><h1 id="letrasrosa" > Usted no tiene actualmnte pedidos en espera de verificación</h1></p>
